...
// var faq = document.getElementsByClassName("consumption-page");
// var i;
// var consump=document.getElementsByClassName("consumption-body");

// for (i = 0; i < faq.length; i++) {

//     faq[i].addEventListener("click", function () {
//     // faq[0].addEventListener("click", function () {
//     // faq[1].classList.toggle("active");
//     // faq[2].classList.toggle("active");
...
// function abc()
// {
//     consBody[0].classList.toggle("active1");
//     consBody[1].classList.toggle("active1");
//     consBody[2].classList.toggle("active1");
//     consBody[3].classList.toggle("active1");
// }
